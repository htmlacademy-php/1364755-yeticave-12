...
<?php endif; ?>" action="add.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form__container-two">
        ...
        <?php endif; ?>">
            ...
            <input id="lot-name" type="text" name="name" value="<?= strip_tags($data['name']) ?>"
    ...
    <div class="form__container-three">
        ...
        <?php endif; ?>">
            ...
            <input id="lot-rate" type="text" name="starting_price" value="<?= strip_tags($data['starting_price']) ?>"
             placeholder="0">
            <?php if (!empty($errors['starting_price'])) : ?>
        ...
        <?php endif; ?>">
            ...
            <input id="lot-step" type="text" name="bet_step" value="<?= strip_tags($data['bet_step']) ?>"
            placeholder="0">
            <?php if (!empty($errors['bet_step'])) : ?>
        ...
        <?php endif; ?>">
            ...
            value="<?= strip_tags($data['date_end']) ?>" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
            <?php if (!empty($errors['date_end'])) : ?>
